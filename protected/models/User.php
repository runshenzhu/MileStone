...
/**
 * This is the model class for table "tb1_user".
 *
 * The followings are the available columns in table 'tb1_user':
 * @property integer $id
...
class User extends TrackStarActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'tb1Projects' => array(self::MANY_MANY, 'Project', 'tb1_project_user_assignment(user_id, project_id)'),
		);
	}
